...
PyAPI_FUNC(int) PyBool_Check(void * arg0);
#define PyBool_CheckExact PyPyBool_CheckExact
PyAPI_FUNC(int) PyBool_CheckExact(void * arg0);
...
PyAPI_FUNC(PyObject *) PyObject_InitVar(PyVarObject *arg0, PyTypeObject *arg1, Signed arg2);
...
PyAPI_FUNC(int) PySlice_Check(void * arg0);
#define PySlice_CheckExact PyPySlice_CheckExact
PyAPI_FUNC(int) PySlice_CheckExact(void * arg0);
...
PyAPI_FUNC(PyObject *) PyTuple_New(Signed arg0);
...
PyAPI_FUNC(PyObject *) PyType_GenericAlloc(PyTypeObject *arg0, Signed arg1);
...
PyAPI_FUNC(PyObject *) _PyObject_NewVar(PyTypeObject *arg0, Signed arg1);
...
PyAPI_FUNC(void) _Py_Dealloc(PyObject *arg0);
